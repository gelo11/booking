...
$this->pageTitle = Yii::t('BookingModule.booking', 'Заказы бронирования - просмотр');
...
$this->menu = array(
    ...
    array('label' => Yii::t('BookingModule.booking', 'Бронирование заказа') . ' «' . mb_substr($model->id, 0, 32) . '»'),
...
<div class="page-header">
    <h1>
        <?php echo Yii::t('BookingModule.booking', 'Просмотр заказа бронирования'); ?><br />
        
    </h1>
</div>

<ul class="nav nav-tabs">
    <li class="active"><a href="#full" data-toggle="tab"><?php echo Yii::t('BookingModule.booking', 'Пример полной версии заказа бронирования'); ?></a></li>
</ul>
<div class="tab-content">
    <div id="full"  class="tab-pane fade">
        <div style="margin-bottom: 20px;">
            <p><?php echo $model->comments; ?></p>
            <span class="label"><?php echo $model->booking_date; ?></span>
