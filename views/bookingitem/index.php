...
$this->pageTitle = Yii::t('BookingModule.booking', 'Объекты бронирования - управление');
...
<div class="page-header">
    <h1>
        <?php echo Yii::t('BookingModule.booking', 'Объекты бронирования'); ?>
...
<button class="btn btn-small dropdown-toggle" data-toggle="collapse" data-target="#search-toggle">
    ...
    <?php echo CHtml::link(Yii::t('BookingModule.booking', 'Поиск объектов бронирования'), '#', array('class' => 'search-button')); ?>
...
<p><?php echo Yii::t('BookingModule.booking', 'В данном разделе представлены средства управления объектами бронирования'); ?></p>
