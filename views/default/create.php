<?php
    $this->breadcrumbs = array(
        ...
        Yii::t('BookingModule.booking', 'Добавление зоны бронирования'),
    );

    $this->pageTitle = Yii::t('BookingModule.booking', 'Зона бронирования - добавление');
...
<div class="page-header">
    <h1>
        <?php echo Yii::t('BookingModule.booking', 'Зона бронирования'); ?>
