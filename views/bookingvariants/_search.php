...
$form = $this->beginWidget('bootstrap.widgets.TbActiveForm', array(
    ...
    <fieldset class="inline">
        <div class="row-fluid control-group">
            ...
            <div class="span3">
                <?php echo $form->dropDownListRow($model, 'booking_id', CHtml::listData($this->module->bookingList, 'id', 'name'), array('empty' => Yii::t('BookingModule.booking', '- не важно -'))); ?>
            </div>
        </div>
        <div class="row-fluid control-group">
            <div class="span6">
    ...
    <?php $this->widget('bootstrap.widgets.TbButton', array(
        ...
        'encodeLabel' => false,
        'buttonType'  => 'submit',
        'label'       => '<i class="icon-search icon-white">&nbsp;</i> ' . Yii::t('blog', 'Искать конфигурацию зоны бронирования'),
    )); ?>
